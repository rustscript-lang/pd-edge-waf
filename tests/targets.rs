...
let values: [string] = ctx_targets(&state, &text, 16387, 123);
...
let remaining: [string] = ctx_targets(&updated, &text, 16387, 123);
...
let regex_remaining: [string] = ctx_targets(&regex_updated, &text, 16387, 123);
...
let counted_remaining: [string] = ctx_targets(&counted_updated, &text, 16387, 123);
...
let broad_remaining: [string] = ctx_targets(&broad_updated, &text, 16387, 123);
